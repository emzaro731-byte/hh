...
class _AIPageState extends State<AIPage> {
  ...
  String title(String x)=>x[0].toUpperCase()+x.substring(1);
  ...
  @override Widget build(BuildContext context){
    final cs=Theme.of(context).colorScheme, media=urls(result);
    return Scaffold(appBar:AppBar(title:const Text('GG AI Studio',style:TextStyle(fontWeight:FontWeight.w900)),actions:[IconButton(onPressed:loadHistory,icon:const Icon(Icons.history))]),
