            ...
            child: ConstrainedBox(
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(
                        colors: [Color(0xFFB35CFF), Color(0xFF3E9BFF)],
                      ),
                      boxShadow: [
                        BoxShadow(
                          color: const Color(0xFF765CFF).withOpacity(.35),
                          blurRadius: 35,
                        ),
                      ],
                    ),
                  ...
                  const Text(
                    'Your account and session are secured by Supabase Auth.',
...
class _UpdatePasswordScreenState extends State<UpdatePasswordScreen> {
  ...
  Future<void> _update() async {
    if (_password.text.length < 6 || _password.text != _confirm.text) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Use matching passwords with at least 6 characters.')),
      );
      return;
    }
